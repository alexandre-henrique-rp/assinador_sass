...
INSERT INTO "new_Document" ("atualName", "clientId", "createdAt", "documentType", "downloadUrl", "extension", "hash", "id", "isSigned", "originalName", "size", "storageManifest", "storagePath", "updatedAt", "uploaderId", "viewUrl") SELECT "atualName", "clientId", "createdAt", "documentType", "downloadUrl", "extension", "hash", "id", "isSigned", "originalName", "size", "storageManifest", "storagePath", "updatedAt", "uploaderId", "viewUrl" FROM "Document";
DROP TABLE "Document";
